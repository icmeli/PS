<form id="form-search-fields" class="form-horizontal {$module}" data-module="{$module}">
	<div class="row">
		...
		<div class="col-lg-4">
			{select label="Lokasyon" name="courses_locationcode" id="courses_locationcode" options=$courses_locationcodeo selected=$courses_locationcode action="filter-btn fa-plus"}
	        {select label="Eğitmen" name="courses_instructor" id="courses_instructor" options=$courses_instructoro selected=$courses_instructor action="filter-btn fa-plus"}
