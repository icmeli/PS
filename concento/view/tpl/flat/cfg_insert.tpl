<form id="form-insert" class="form-horizontal">
	<div class="row">
		...
		<div class="col-lg-4">
			{select label="##Product## ##Statusu##" name="cfg_status"  id="cfg_status" options=$cfg_statuso selected=$cfg_status onchange="checkCfgStatus();"}
		...
		<div class="col-lg-4">			
			...
			{input label="##Description##" name="cfg_description" id="gcfg_description" value="{$cfg_description}"}
